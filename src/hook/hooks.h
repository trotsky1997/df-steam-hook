...
#define SETUP_ORIG_FUNC(fn_name) fn_name fn_name##_orig = (fn_name)((UINT64)GetModuleHandle(0) + Config::Offset::fn_name);
#define SETUP_ORIG_FUNC_FNAME(fn_name, module_name) fn_name fn_name##_orig = (fn_name)(GetProcAddress(GetModuleHandle(#module_name), #fn_name));
