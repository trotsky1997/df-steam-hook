...
target("dfint_hook")
    ...
    set_targetdir("D:\\Games\\Dwarf Fortress 50.07\\dfint_data") -- build to DF dir, handy for testing
...
target("dfint_launcher")
    ...
    set_targetdir("D:\\Games\\Dwarf Fortress 50.07\\") -- build to DF dir, handy for testing
